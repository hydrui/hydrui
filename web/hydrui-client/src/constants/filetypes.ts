...
export const filetypeEnumToString: Map<HydrusFileType, string> = new Map([
  ...
  [HydrusFileType.UNDETERMINED_WM, "undetermined: wma or wmv"],
  [HydrusFileType.UNDETERMINED_MP4, "undetermined: mp4 with or without audio"],
  [HydrusFileType.UNDETERMINED_PNG, "undetermined: png or apng"],
  [HydrusFileType.UNDETERMINED_OLE, "undetermined: ole file"],
  [HydrusFileType.UNDETERMINED_GIF, "undetermined: animated or static gif"],
  [HydrusFileType.UNDETERMINED_WEBP, "undetermined: animated or static webp"],
