...
export const filetypeEnumToExt: Map<HydrusFileType, string> = new Map([
  [HydrusFileType.APPLICATION_HYDRUS_CLIENT_COLLECTION, "bin"],
  ...
  [HydrusFileType.IMAGE_SVG, "svg"],
  [HydrusFileType.IMAGE_HEIF, "heif"],
  [HydrusFileType.IMAGE_HEIF_SEQUENCE, "heif"],
  [HydrusFileType.IMAGE_HEIC, "heic"],
  [HydrusFileType.IMAGE_HEIC_SEQUENCE, "heic"],
  [HydrusFileType.IMAGE_AVIF, "avif"],
  [HydrusFileType.IMAGE_AVIF_SEQUENCE, "avif"],
  [HydrusFileType.IMAGE_JXL, "jxl"],
  ...
  [HydrusFileType.APPLICATION_PSD, "psd"],
  [HydrusFileType.APPLICATION_CLIP, "clip"],
  [HydrusFileType.APPLICATION_SAI2, "sai"],
  ...
  [HydrusFileType.APPLICATION_HYDRUS_ENCRYPTED_ZIP, "zip"],
  [HydrusFileType.APPLICATION_HYDRUS_UPDATE_CONTENT, "bin"],
  [HydrusFileType.APPLICATION_HYDRUS_UPDATE_DEFINITIONS, "bin"],
  [HydrusFileType.AUDIO_M4A, "m4a"],
  [HydrusFileType.AUDIO_MP3, "mp3"],
  [HydrusFileType.AUDIO_OGG, "ogg"],
  [HydrusFileType.AUDIO_FLAC, "flac"],
  ...
  [HydrusFileType.AUDIO_REALMEDIA, "rm"],
  [HydrusFileType.AUDIO_TRUEAUDIO, "tta"],
  [HydrusFileType.AUDIO_WMA, "wma"],
  [HydrusFileType.AUDIO_WAVPACK, "wavpack"],
  [HydrusFileType.TEXT_HTML, "html"],
  ...
  [HydrusFileType.VIDEO_WEBM, "webm"],
  [HydrusFileType.UNDETERMINED_WM, "asf"],
  [HydrusFileType.UNDETERMINED_MP4, "mp4"],
  [HydrusFileType.UNDETERMINED_PNG, "png"],
  [HydrusFileType.UNDETERMINED_OLE, "ole"],
  [HydrusFileType.UNDETERMINED_GIF, "gif"],
  [HydrusFileType.UNDETERMINED_WEBP, "webp"],
  [HydrusFileType.APPLICATION_UNKNOWN, "bin"],
  [HydrusFileType.GENERAL_APPLICATION, "bin"],
  [HydrusFileType.GENERAL_APPLICATION_ARCHIVE, "bin"],
  [HydrusFileType.GENERAL_IMAGE_PROJECT, "bin"],
  [HydrusFileType.GENERAL_AUDIO, "bin"],
  [HydrusFileType.GENERAL_IMAGE, "bin"],
  [HydrusFileType.GENERAL_VIDEO, "bin"],
  [HydrusFileType.GENERAL_ANIMATION, "bin"],
]);
